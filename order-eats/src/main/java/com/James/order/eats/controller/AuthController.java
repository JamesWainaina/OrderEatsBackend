...
import com.James.order.eats.requests.LoginRequest;
import com.James.order.eats.response.AuthResponse;
import com.James.order.eats.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse>createUserHandler(@RequestBody User user) throws Exception{
        ...
        if(isEmailExists != null){
            throw new Exception("Email already exists!...Retry with another email");
        }
